...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 章节:${parent.title}&raquo; 添加小节
	</div>
		...
		<table class="input">
			...
			<tr>
			   <th>
				...
				<td>
					<textarea rows="6" name="summary" style="width:500px;"></textarea>
				</td>
			</tr>
			--]
			<tr>
