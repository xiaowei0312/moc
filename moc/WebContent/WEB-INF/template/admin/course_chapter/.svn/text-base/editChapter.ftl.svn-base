...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 编辑章节
	</div>
		...
		<table class="input">
			...
			<tr>
			   <th>
				...
				<td>
					<textarea onKeyUp="if(this.value.length > 500){ this.value=this.value.substr(0,500); alert('最多500个字符');}" rows="6" name="summary" style="width:500px;">${courseChapter.summary}</textarea>
				</td>
			</tr>
			<tr>
				<th>
