...
<title>${message("admin.product.add")} - QQQQQQQQQQQQ</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 添加材料题
	</div>
	...
	<input type="hidden" name="questionType" value="material" />
		<table class="input tabContent" >
			[#if materialID=0 || !(materialID??)]
				<tr>
					<th>
						<span class="requiredField">*</span>大纲类别:
					</th>
					<td>
		...
		<table class="input">
			<tr>
				...
				<td>
					<input type="button" class="button submitAdd" value="保存并添加子题" />				
