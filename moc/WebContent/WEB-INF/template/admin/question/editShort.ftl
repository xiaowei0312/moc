...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> [#if materialID??] &raquo; 编辑材料子题[/#if]&raquo; 编辑简答题
	</div>
	<form id="inputForm" action="update.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<textarea name="answer" cols="50" rows="4">${question.answer}</textarea>
				</td>
			</tr>
		</table>
		<table class="input">
