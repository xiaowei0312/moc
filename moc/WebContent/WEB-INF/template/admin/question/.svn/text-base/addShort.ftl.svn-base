...
//类别选择
	...
	$submitAdd.click(function(){
		...
		//是否填写了答案
		if($("#answer").attr("value")==null ||$.trim($("#answer").attr("value"))==""){
			$.message("warn","请填写答案");
			return false;			
		} 
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> [#if materialID??] &raquo; 添加材料子题[/#if]&raquo; 添加简答题
	</div>
	<form id="inputForm" action="save.jhtml" method="post" enctype="multipart/form-data">
		<input type="hidden" name="questionType" id="questionType" value="essay"/>
		...
		<table class="input tabContent">
		   [#if materialID=0 || !(materialID??)]
			...
			<tr>
				<th>
					<span class="requiredField">*</span>答案:
				</th>
				<td>
