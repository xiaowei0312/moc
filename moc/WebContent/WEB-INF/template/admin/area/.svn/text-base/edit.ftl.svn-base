...
<title>${message("admin.area.edit")} - Powered By Sram</title>
...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			...
			<tr>
				<th>
					<span class="requiredField">*</span>全称:
				</th>
				<td>
					<input type="text" name="fullName" class="text" value="${area.fullName}" maxlength="100" />
				</td>
			</tr>
			<tr>
				<th>
