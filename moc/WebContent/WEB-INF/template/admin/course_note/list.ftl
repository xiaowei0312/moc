...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 笔记列表 (${courseTitle})<span>(${message("admin.page.total", page.total)})</span>
	</div>
	...
	<input type="hidden" value="${courseId}" name="courseId" />
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						...
						[/#if]
						<li>
							<a href="javascript:;"[#if page.searchProperty == "courseLesson"] class="current"[/#if] val="courseLesson">课时名</a>
						</li>
						<li>
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="title">笔记内容</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="articleCategory">所属课时</a>
				</th>
				<th>
				...
				<th>
					<a href="javascript:;" class="sort" name="isPublication">是否私有</a>
				</th>
				<th>
			...
			[#list page.content as courseNote]
				<tr>
					...
					<td>
						${courseNote.courseLesson.course.title}
					</td>
					<td>
						${courseNote.member.username}
					</td>
					<td>
						<span class="[#if courseNote.status=1]false[#else]true[/#if]Icon">&nbsp;</span>
					</td>
					<td>
