...
<%@page import="com.sram.Setting"%>
<%@page import="com.sram.util.SettingUtils"%>
<%@page import="com.sram.util.SpringUtils"%>
<%@page import="com.sram.Setting.CaptchaType"%>
<%@page import="com.sram.Setting.AccountLockType"%>
<%@page import="com.sram.service.RSAService"%>
...
%>
<title><%=SpringUtils.getMessage("admin.login.title")%> - Powered By Sram</title>
			...
			<form id="loginForm" action="login.jsp" method="post">
				...
				<table>
					<tr>
						...
						<td>
							<input type="text" id="username" name="username" class="text" maxlength="20" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<th>
				...
				<div class="powered">COPYRIGHT © 2005-2017 SRAM-EDU.COM ALL RIGHTS RESERVED.</div>
				<div class="link">
					<a href="<%=base%>/"><%=SpringUtils.getMessage("admin.login.home")%></a> |
					<a href="http://www.sram-edu.com"><%=SpringUtils.getMessage("admin.login.official")%></a> |
					<a href="http://bbs.sram-edu.com"><%=SpringUtils.getMessage("admin.login.bbs")%></a> |
					<a href="<%=base%>/about.html"><%=SpringUtils.getMessage("admin.login.about")%></a> |
					<a href="<%=base%>/contact.html"><%=SpringUtils.getMessage("admin.login.contact")%></a> 
				</div>
			</form>
		</div>
	<%} else {%>
