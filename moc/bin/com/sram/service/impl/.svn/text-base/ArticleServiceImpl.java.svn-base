...
public class ArticleServiceImpl extends BaseServiceImpl<Article, Long> implements ArticleService, DisposableBean {
	...
	public Article findPrevArticle(Article article) {
		return articleDao.findPrevArticle(article);
	}
	@Transactional(readOnly = true)
	public Page<Object[]> findPageCategoryName(Pageable pageable) {
		return articleDao.findPageCategoryName(pageable);
	}
	
	@Transactional(readOnly = true)
	public Article findNextArticle(Article article) {
		return articleDao.findNextArticle(article);
	}
	...
	public void save(Article article) {
		...
		super.save(article);
		articleDao.flush();
		staticService.build(article,null,null);
	}
	...
	public Article update(Article article) {
		...
		articleDao.flush();
		staticService.build(pArticle,null,null);
		return pArticle;
	}
