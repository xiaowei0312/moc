...
public class Setting implements Serializable {
	...
	/** 云服务器地址 */
	private String cloudServerSite;
	...
	@NotEmpty
	@Length(max = 200)
	public String getCloudServerSite() {
		return cloudServerSite;
	}

	public void setCloudServerSite(String cloudServerSite) {
		this.cloudServerSite = cloudServerSite;
	}
