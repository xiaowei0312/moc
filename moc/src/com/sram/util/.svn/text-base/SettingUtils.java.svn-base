...
public final class SettingUtils {
	...
	public static Setting get() {
		...
		if (cacheElement != null) {
			...
			setting = new Setting();
			try {
				File sramXmlFile = new ClassPathResource(CommonAttributes.SRAM_XML_PATH).getFile();
				Document document = new SAXReader().read(sramXmlFile);
				List<Element> elements = document.selectNodes("/sram/setting");
