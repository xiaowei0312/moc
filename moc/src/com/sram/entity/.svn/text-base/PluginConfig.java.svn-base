 ...
 */
@Entity
@Table(name = "moc_plugin_config")
@SequenceGenerator(name = "sequenceGenerator", sequenceName = "moc_plugin_config_sequence")
public class PluginConfig extends OrderEntity {
	...
	@CollectionTable(name = "moc_plugin_config_attribute")
