...
import com.sram.HtmlCleanEditor;
...
public class BaseController {
	...
	/** 错误视图 */
	protected static final String ERROR_VIEW = "/moc/common/error";

	/** 资源找不到 */
	protected static final String RESOURCE_NOT_FOUND = "/moc/common/resource_not_found";

	/** 错误消息 */
	protected static final Message ERROR_MESSAGE = Message.error("moc.message.error");

	/** 成功消息 */
	protected static final Message SUCCESS_MESSAGE = Message.success("moc.message.success");
